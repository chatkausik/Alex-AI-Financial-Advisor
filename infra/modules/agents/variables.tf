...
variable "polygon_api_key"     { type = string; sensitive = true }
variable "polygon_plan"        { type = string; default = "free" }
variable "langfuse_public_key" { type = string; default = "" }
variable "langfuse_secret_key" { type = string; sensitive = true; default = "" }
variable "langfuse_host"       { type = string; default = "https://cloud.langfuse.com" }
variable "openai_api_key"      { type = string; sensitive = true; default = "" }
variable "planner_memory"      { type = number; default = 2048 }
